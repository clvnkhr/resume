...
\begin{rubric}{Employment History}
    \entry*[\mydaterange{2023}{now}]%
	\textbf{Associate Consultant.} \emph{Digiterre Solutions Ltd, London.}

	Designing and implementing Python and Databricks-based cloud solutions in the finance and energy space to migrate customers off legacy technology built around Matlab. Onboarded data to new platform for researchers to analyse.%
	\entry*[\mydaterange{2021}{2023}]%
